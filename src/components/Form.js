...
export default function Form() {
  ...
  const editHandler = (item, id) => {
    ...
    cloneState.email = item.email;
    cloneState.phone = item.phone;
    cloneState.gender = item.gender;
    cloneState.city = item.city;
      ...
      <div className="row mt-3">
        <div className="col-3">
          <form onSubmit={onSubmitHandler}>
            ...
            {
                !updateStatus?<button type="submit" className="btn btn-primary float-right">
                Submit
              </button>:<button type="submit"  className="btn btn-primary float-right">
              update
            </button>
            }
          </form>
